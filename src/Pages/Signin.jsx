...
import Siginimg from './../images/Signin.png'
function Signin() {
   ...
   <div className="pt-20 p-1 text-center">
       ...
       <div className='border-2 border-balck rounded-[40px] border-dashed flex flex-warp w-[60%] mx-auto p-2  mt-[2%] '>
         ...
         <form>
           ...
           <input type="password" placeholder="Password" className='border-2 border-balck mt-3 p-2 w-[80%] rounded-[40px]' />
            <input type="password" placeholder="Password" className='border-2 border-balck mt-3 mb-5 p-2 w-[80%] rounded-[40px]' />
           <button type="submit" className='border-2 border-balck mt-3 mb-5 p-2 w-[80%] bg-[#000000] rounded-[40px] text-white hover:bg-[#F2A65A]'>Sign-in</button>
         </form>
          <p> have an account? <button className='text-[blue] mb-2 'onClick={()=>navigate("/login")} >Login</button></p>
         </div>
         <div className=' w-[60%] rounded-[40px]'>
             <img src={Siginimg} alt="Signin" className="w-[90%] h-[100%] mx-auto rounded-[40px]" />
         </div>
       </div>
